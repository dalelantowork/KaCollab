...
<html lang="en">
  ...
  <body>
        ...
        <div class="bg-body-extra-light">
          <div class="content py-0">
            <ul class="nav nav-tabs nav-tabs-alt border-bottom-0 justify-content-center justify-content-md-start">
              <li class="nav-item">
                <a class="nav-link text-body-color py-4 active" href="db_crypto.html">
                  <i class="fa fa-rocket fa-fw opacity-50"></i> <span class="d-none d-md-inline ms-1">Dashboard</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-body-color py-4" href="db_crypto.html">
                  <i class="fa fa-arrows-alt-h fa-fw opacity-50"></i> <span class="d-none d-md-inline ms-1">Fund Movements</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-body-color py-4" href="db_crypto.html">
          ...
          <div class="block block-rounded">
            <ul class="nav nav-tabs nav-tabs-block align-items-center">
              <li class="nav-item">
                <a class="nav-link text-body-color active" href="javascript:void(0)">
                  ...
                  <span class="d-none d-sm-inline">Total income for the last 30 days <span class="text-muted fs-sm">PHP 360,000</span></span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-body-color" href="javascript:void(0)">
                  <span class="d-sm-none">ETH</span>
                  <span class="d-none d-sm-inline">Last 7 days <span class="text-muted fs-sm">PHP 84,000</span></span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-body-color" href="javascript:void(0)">
                  <span class="d-sm-none">LTC</span>
                  <span class="d-none d-sm-inline">Yesterday <span class="text-muted fs-sm">PHP 14,000</span></span>
                </a>
              </li>
            ...
            <div class="block-content block-content-full border-bottom">
              <div class="row text-center">
                ...
                <div class="col-lg-4 py-3">
                  <div class="fs-1 fw-light text-dark mb-0">
                    <span class="text-success">+</span> PHP 42,000
                  </div>
                  <div class="fs-sm fw-bold text-muted text-uppercase">
                    Since Last Month
                  </div>
            ...
            <div class="block-content block-content-full">
              ...
              <canvas id="js-chartjs-bitcoin" height="400"></canvas>
            </div>
          </div>
            ...
            <div class="col-xl-6">
              ...
              <div class="d-flex flex-column block block-rounded h-100 mb-0">
                <div class="flex-grow-0 block-header block-header-default">
                  <h3 class="block-title">Top Office Income</h3>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="d-none d-sm-table-cell text-end text-muted">
                          <span class="fs-sm">~ PHP 120,000</span>
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td>
                          <strong>City Treasury Office</strong>
                        </td>
                        ...
                        <td class="text-end">
                          <span class="fs-sm">30%</span>
                        </td>
                        <td class="d-none d-sm-table-cell text-end text-muted">
                          <span class="fs-sm">~ PHP 36,300</span>
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td>
                          <strong>Assessors Office</strong>
                        </td>
                        <td class="d-none d-sm-table-cell">
                          <div class="progress mb-0" style="height: 10px;">
                            <div class="progress-bar bg-muted" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: 20%"></div>
                          </div>
                        </td>
                        <td class="text-end">
                          <span class="fs-sm">20%</span>
                        </td>
                        <td class="d-none d-sm-table-cell text-end text-muted">
                          <span class="fs-sm">~ PHP 25,000</span>
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td class="d-none d-sm-table-cell text-end text-muted">
                          <span class="fs-sm">~ PHP 20,000</span>
                        </td>
                      </tr>
                      <tr>
                        <td>
                  ...
                  <table class="table table-striped table-borderless table-vcenter">
                    <tbody>
                      <tr>
                        ...
                        <td class="d-none d-sm-table-cell">
                          <div class="fw-semibold">Paid Processing Fee</div>
                          <div class="fs-sm text-muted">Taxable Amount</div>
                        </td>
                        <td class="text-end">
                          <div class="fw-semibold">+ PHP 100.00</div>
                          <div class="fs-sm text-muted">PHP 0.00</div>
                        </td>
                      </tr>
                      <tr>
    ...
    <!-- Page JS Code -->
    <script src="{{asset('js/pages/db_crypto.min.js')}}"></script>
  </body>
</html>
