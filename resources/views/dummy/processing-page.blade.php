            ...
            <div class="col-6 col-lg-3">
              <a class="block block-rounded block-link-shadow text-center h-100 mb-0" href="javascript:void(0)">
                <div class="block-content py-5">
                  ...
                  <p class="fw-semibold fs-sm text-muted text-uppercase mb-0">
                    Still Being Reviewed by City Admin
                  </p>
                </div>
              </a>
            </div>
                ...
                <table class="table table-borderless table-striped table-vcenter fs-sm">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center">Last Viewed By</th>
                      <th class="text-end" style="width: 10%;">Date Submitted</th>
                      <th class="text-end" style="width: 10%;">Date Approved</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td class="text-center"><a href="javascript:void(0);"><strong>PID.965</strong></a></td>
                      <td><a href="javascript:void(0);"><strong>Fire Clearance</strong></a></td>
                      <td class="text-center">Approved</td>
                      <td class="text-center"><strong>City Engineering Office Staff</strong></td>
                      <td class="text-end">February 1, 2023</td>
                      <td class="text-end">February 2, 2023</td>
                    </tr>
                    <tr>
                      <td class="text-center"><a href="javascript:void(0);"><strong>PID.755</strong></a></td>
                      <td><a href="javascript:void(0);"><strong>PhilHealth Clearance</strong></a></td>
                      <td class="text-center">Approved</td>
                      <td class="text-center"><strong>City Health Office Staff</strong></td>
                      <td class="text-end">February 1, 2023</td>
                      <td class="text-end">February 2, 2023</td>
                    </tr>
                    <tr>
                      <td class="text-center"><a href="javascript:void(0);"><strong>PID.235</strong></a></td>
                      <td><a href="javascript:void(0);"><strong>SSS</strong></a></td>
                      <td class="text-center">Pending</td>
                      <td class="text-center"><strong>City Admin Office Staff</strong></td>
                      <td class="text-end">February 1, 2023</td>
                      <td class="text-end">Not Yet Approved</td>
                    </tr>
                  </tbody>
                </table>
              </div>
          ...
          <div class="row">
            <div class="col-sm-6">
              ...
              <div class="block block-rounded">
                ...
                <div class="block-content">
                  <div class="fs-4 mb-1">Juan Dela Cruz Business</div>
                  <address class="fs-sm">
                    #1 Kalye Street<br>
                    Metro Manila<br>
                    Philippines<br><br>
                    <i class="fa fa-phone"></i> +63 (999) 123-4567<br>
            ...
            <div class="col-sm-6">
              ...
              <div class="block block-rounded">
                <div class="block-header block-header-default">
                  <h3 class="block-title">Owner's Address</h3>
                </div>
                <div class="block-content">
                  <div class="fs-4 mb-1">Juan Dela Cruz</div>
                  <address class="fs-sm">
                  ...
                  <tbody>
                    <tr>
                      <td class="fs-base" style="width: 80px;">
                        <span class="badge bg-info">Final Review</span>
                      </td>
                      <td style="width: 220px;">
                        <span class="fw-semibold">February 2, 2023 - 18:00</span>
                      </td>
                      <td>
                        <a href="javascript:void(0)">City Admin</a>
                      </td>
                      <td class="text-success"><strong>Final Review in Progress</strong></td>
                    </tr>
                    <tr>
                      <td class="fs-base">
                      ...
                      <td>
                        <span class="fw-semibold">February 2, 2023 - 17:36</span>
                      </td>
                      <td>
                        <a href="javascript:void(0)">City Admin</a>
                      </td>
                      <td class="text-warning"><strong>Being Reviewed by the City Admin</strong></td>
                    </tr>
                    <tr>
                      <td class="fs-base">
                      ...
                      <td>
                        <span class="fw-semibold">February 1, 2023 - 18:10</span>
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>
                        <span class="fw-semibold">February 1, 2023 - 15:35</span>
                      </td>
                      <td>
                        <a href="javascript:void(0)">Support</a>
                      </td>
                      <td class="text-danger"><strong>Missing documents requested.</strong></td>
                    </tr>
                    <tr>
                      <td class="fs-base">
                      ...
                      <td>
                        <span class="fw-semibold">February 1, 2023 - 14:59</span>
                      </td>
                      <td>
                        <a href="javascript:void(0)">City Admin</a>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <span class="fw-semibold">February 1, 2023 - 14:29</span>
                      </td>
                      <td>
                        <a href="javascript:void(0)">Juan Dela Cruz</a>
                      </td>
