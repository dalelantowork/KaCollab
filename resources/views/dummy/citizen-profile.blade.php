      ...
      <main id="main-container">
          ...
          <div class="bg-black-25">
            <div class="content content-full">
              <div class="py-5 text-center">
                ...
                <h1 class="fw-bold my-2 text-white">Juan Dela Cruz</h1>
                <h2 class="h4 fw-bold text-white-75">
                  Citizen <a class="text-primary-lighter" href="javascript:void(0)">@Sample Barangay Name</a>
                </h2>
        ...
        <div class="content content-full content-boxed">
          ...
          <h2 class="content-heading">
            <i class="si si-users me-1"></i> Immediate Family Members
          </h2>
          <div class="row">
            <div class="col-md-6 col-xl-3">
              <div class="block block-rounded text-center">
                <div class="block-content block-content-full bg-image" style="background-image: url('{{asset('media/photos/photo15.jpg')}}');">
                  <img class="img-avatar img-avatar-thumb" src="{{asset('media/avatars/avatar6.jpg')}}" alt="">
                </div>
                <div class="block-content block-content-full block-content-sm bg-body-light">
                  <div class="fw-semibold">Juana Dela Cruz</div>
                  <div class="fs-sm text-muted">Citizen</div>
                </div>
                <div class="block-content block-content-full">
                  <a class="btn btn-sm btn-alt-secondary" href="javascript:void(0)">
                    <i class="fa fa-message text-muted me-1"></i> Message
                  </a>
                  <a class="btn btn-sm btn-alt-secondary" href="javascript:void(0)">
            ...
            <div class="col-md-6 col-xl-3">
              <div class="block block-rounded text-center">
                <div class="block-content block-content-full bg-image" style="background-image: url('{{asset('media/photos/photo4.jpg')}}');">
                  <img class="img-avatar img-avatar-thumb" src="{{asset('media/avatars/avatar16.jpg')}}" alt="">
                </div>
                <div class="block-content block-content-full block-content-sm bg-body-light">
                  <div class="fw-semibold">Pedro Dela Cruz</div>
                  <div class="fs-sm text-muted">Citizen</div>
                </div>
                <div class="block-content block-content-full">
                  <a class="btn btn-sm btn-alt-secondary" href="javascript:void(0)">
            ...
            <div class="col-md-6 col-xl-3">
              <div class="block block-rounded text-center">
                <div class="block-content block-content-full bg-image" style="background-image: url('{{asset('media/photos/photo1.jpg')}}');">
                  <img class="img-avatar img-avatar-thumb" src="{{asset('media/avatars/avatar13.jpg')}}" alt="">
                </div>
                <div class="block-content block-content-full block-content-sm bg-body-light">
                  <div class="fw-semibold">Maria Dela Cruz</div>
                  <div class="fs-sm text-muted">Citizen</div>
                </div>
                <div class="block-content block-content-full">
                  <a class="btn btn-sm btn-alt-secondary" href="javascript:void(0)">
            ...
            <div class="col-md-6 col-xl-3">
              <div class="block block-rounded text-center">
                <div class="block-content block-content-full bg-image" style="background-image: url('{{asset('media/photos/photo3.jpg')}}');">
                  <img class="img-avatar img-avatar-thumb" src="{{asset('media/avatars/avatar2.jpg')}}" alt="">
                </div>
                <div class="block-content block-content-full block-content-sm bg-body-light">
                  <div class="fw-semibold">Anna Dela Cruz</div>
                  <div class="fs-sm text-muted">Citizen</div>
                </div>
                <div class="block-content block-content-full">
                  <a class="btn btn-sm btn-alt-secondary" href="javascript:void(0)">
          ...
          <div class="text-end">
            <button type="button" class="btn btn-alt-primary">
              View more family members <i class="fa fa-arrow-right ms-1"></i>
            </button>
          </div>
          <!-- END Latest Friends -->
          ...
          <!-- Latest Projects -->
          <h2 class="content-heading">
            <i class="si si-briefcase me-1"></i> Registered Businesses
          </h2>
          <div class="row">
            <div class="col-md-6 col-xl-3">
              <div class="block block-rounded text-center">
                ...
                <div class="block-content block-content-full block-content-sm bg-body-light">
                  <div class="fw-semibold">Computer Shop</div>
                  <div class="fs-sm text-muted">#1 Kalye, Sample Barangay, Sample City</div>
                </div>
                <div class="block-content block-content-full">
                  <a class="btn btn-sm btn-alt-secondary" href="javascript:void(0)">
                    <i class="fa fa-briefcase text-muted me-1"></i> View Business
                  </a>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-xl-3">
              <div class="block block-rounded text-center">
                ...
                <div class="block-content block-content-full block-content-sm bg-body-light">
                  <div class="fw-semibold">Phone Shop</div>
                  <div class="fs-sm text-muted">#2 Kalye, Sample Barangay, Sample City</div>
                </div>
                <div class="block-content block-content-full">
                  <a class="btn btn-sm btn-alt-secondary" href="javascript:void(0)">
                    <i class="fa fa-briefcase text-muted me-1"></i> View Business
            ...
            <div class="col-md-6 col-xl-3">
              <div class="block block-rounded text-center">
                ...
                <div class="block-content block-content-full block-content-sm bg-body-light">
                  <div class="fw-semibold">Sports Shop</div>
                  <div class="fs-sm text-muted">#3 Kalye, Sample Barangay, Sample City</div>
                </div>
                <div class="block-content block-content-full">
                  <a class="btn btn-sm btn-alt-secondary" href="javascript:void(0)">
                    <i class="fa fa-briefcase text-muted me-1"></i> View Business
            ...
            <div class="col-md-6 col-xl-3">
              <div class="block block-rounded text-center">
                ...
                <div class="block-content block-content-full block-content-sm bg-body-light">
                  <div class="fw-semibold">Party Needs Shop</div>
                  <div class="fs-sm text-muted">#4 Kalye, Sample Barangay, Sample City</div>
                </div>
                <div class="block-content block-content-full">
                  <a class="btn btn-sm btn-alt-secondary" href="javascript:void(0)">
                    <i class="fa fa-briefcase text-muted me-1"></i> View Business
          ...
          <!-- Latest Posts -->
          <h2 class="content-heading">
            <i class="si si-note me-1"></i> Latest Activities
          </h2>
          <a class="block block-rounded block-link-shadow mb-3" href="javascript:void(0)">
            <div class="block-content block-content-full d-flex align-items-center justify-content-between">
              <h4 class="fs-base text-primary mb-0">
                <i class="fa fa-newspaper text-muted me-1"></i> Business Permit Application
              </h4>
          ...
          <a class="block block-rounded block-link-shadow mb-3" href="javascript:void(0)">
            <div class="block-content block-content-full d-flex align-items-center justify-content-between">
              <h4 class="fs-base text-primary mb-0">
                <i class="fa fa-newspaper text-muted me-1"></i> Renewal of Business Permit
              </h4>
              <p class="fs-sm text-muted mb-0 ms-2 text-end">
                2 days ago
              </p>
          ...
          <a class="block block-rounded block-link-shadow mb-3" href="javascript:void(0)">
            <div class="block-content block-content-full d-flex align-items-center justify-content-between">
              <h4 class="fs-base text-primary mb-0">
                <i class="fa fa-newspaper text-muted me-1"></i> Real Property Tax Payment
              </h4>
              <p class="fs-sm text-muted mb-0 ms-2 text-end">
                1 week ago
              </p>
          ...
          <a class="block block-rounded block-link-shadow mb-3" href="javascript:void(0)">
            <div class="block-content block-content-full d-flex align-items-center justify-content-between">
              <h4 class="fs-base text-primary mb-0">
                <i class="fa fa-newspaper text-muted me-1"></i> Franchise Renewal
              </h4>
              <p class="fs-sm text-muted mb-0 ms-2 text-end">
                2 weeks ago
              </p>
          ...
          <a class="block block-rounded block-link-shadow mb-3" href="javascript:void(0)">
            <div class="block-content block-content-full d-flex align-items-center justify-content-between">
              <h4 class="fs-base text-primary mb-0">
                <i class="fa fa-newspaper text-muted me-1"></i> RPT Clearance Payment
              </h4>
              <p class="fs-sm text-muted mb-0 ms-2 text-end">
                1 month ago
              </p>
