...
<html lang="en">
  ...
  <body>
        ...
        <div class="content content-full">
          ...
          <div class="row items-push">
              ...
              <a class="block block-rounded block-fx-pop text-center h-100 mb-0" href="javascript:void(0)">
                <div class="block-content block-content-full">
                  <div class="item item-circle bg-primary-lighter mx-auto my-3">
                    <i class="fa fa-money-bill-trend-up text-primary"></i>
                  </div>
                  <div class="display-4 fw-bold">3.69m</div>
              ...
              <a class="block block-rounded block-fx-pop text-center h-100 mb-0" href="javascript:void(0)">
                <div class="block-content block-content-full">
                  <div class="item item-circle bg-xinspire-lighter mx-auto my-3">
                    <i class="fa fa-money-bill-wheat text-xinspire-dark"></i>
                  </div>
                  <div class="display-4 fw-bold">985k</div>
                  <div class="text-muted mt-1">Expenditures</div>
              ...
              <a class="block block-rounded block-fx-pop text-center h-100 mb-0" href="javascript:void(0)">
                <div class="block-content block-content-full">
                  <div class="item item-circle bg-xsmooth-lighter mx-auto my-3">
                    <i class="fa fa-users text-xsmooth"></i>
                  </div>
                  <div class="display-4 fw-bold">25.1k</div>
                  <div class="text-muted mt-1">Paying Citizens</div>
                  <div class="py-3 fs-4 fw-bold text-success">
                    <i class="fa fa-caret-up me-1"></i>
                    52.5%
                  </div>
            ...
            <div class="col-sm-6 col-xl-3">
              <a class="block block-rounded block-fx-pop text-center h-100 mb-0" href="javascript:void(0)">
                <div class="block-content block-content-full">
                  <div class="item item-circle bg-success-op mx-auto my-3">
                    <i class="fa fa-level-up-alt text-success"></i>
                  </div>
                  <div class="display-4 fw-bold">12.5%</div>
                  <div class="text-muted mt-1">Financial Trend</div>
                  <div class="py-3 fs-4 fw-bold text-danger">
                    <i class="fa fa-caret-down me-1"></i>
                    5.7%
                  </div>
          ...
          <div class="d-flex justify-content-between align-items-center pt-5 pb-3">
            <h2 class="h3 fw-normal mb-0">Financial Growth</h2>
            <div class="dropdown">
              ...
              <div class="row">
                <div class="col-md-5 col-lg-4 d-md-flex align-items-md-center">
                  <div class="p-md-2 p-lg-3">
                    <div class="display-4 fw-bold">3,687,501</div>
                    <div class="fs-lg fw-bold">Total income this month</div>
                    <div class="py-3 d-flex align-items-center">
                      <div class="bg-success-light px-2 py-1 rounded me-3">
                        <i class="fa fa-fw fa-caret-up text-success"></i>
                      </div>
                      <p class="mb-0">
                        You have a <span class="fw-semibold text-success">25% More Income</span> in the last 30 days.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div class="row items-push">
            <div class="col-6 col-lg-3">
              <a class="block block-rounded block-fx-pop h-100 mb-0" href="javascript:void(0)">
                <div class="block-content block-content-full">
                  <div class="fs-5 fw-semibold text-muted mb-3">Business Permit and Licensing Office</div>
                  <div class="fs-2 fw-bold">1,261,300</div>
            ...
            <div class="col-6 col-lg-3">
              <a class="block block-rounded block-fx-pop h-100 mb-0" href="javascript:void(0)">
                <div class="block-content block-content-full">
                  <div class="fs-5 fw-semibold text-muted mb-3">City Assessors Office</div>
                  <div class="fs-2 fw-bold">910,800</div>
                  <div class="fs-4 fw-bold text-success">
                    <i class="fa fa-caret-up me-1"></i>
                    18.6%
                  </div>
            ...
            <div class="col-6 col-lg-3">
              <a class="block block-rounded block-fx-pop h-100 mb-0" href="javascript:void(0)">
                <div class="block-content block-content-full">
                  <div class="fs-5 fw-semibold text-muted mb-3">City Treasury Office</div>
                  <div class="fs-2 fw-bold">575,000</div>
                  <div class="fs-4 fw-bold text-success">
                    <i class="fa fa-caret-up me-1"></i>
                    14.9%
                  </div>
            ...
            <div class="col-6 col-lg-3">
              <a class="block block-rounded block-fx-pop h-100 mb-0" href="javascript:void(0)">
                <div class="block-content block-content-full">
                  <div class="fs-5 fw-semibold text-muted mb-3">Other Offices</div>
                  <div class="fs-2 fw-bold">1,090,100</div>
    ...
    <!-- Page JS Code -->
    <script src="{{asset('js/pages/db_analytics.min.js')}}"></script>
  </body>
</html>
