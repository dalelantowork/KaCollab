                  ...
                  <div class="row w-100 text-center">
                    <div class="col-6 col-xl-4 offset-xl-4">
                      ...
                      <p class="fs-sm fw-semibold text-white-75 text-uppercase mb-0">
                        <i class="far fa-chart-bar opacity-75 me-1"></i> Total Accomplished
                      </p>
                    </div>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="d-none d-sm-table-cell fs-base">
                          <span class="badge bg-dark">Citizen</span>
                        </td>
                        <td class="text-center">
                      ...
                      <tr>
                        ...
                        <td class="d-none d-sm-table-cell fs-base">
                          <span class="badge bg-black-50">Unverified Citizen</span>
                        </td>
                        <td class="text-center">
                          <a href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-placement="left" title="Edit User">
                            <i class="fa fa-fw fa-pencil-alt"></i>
                      ...
                      <tr>
                        <td class="text-center">
                          <img class="img-avatar img-avatar32 img-avatar-thumb" src="{{asset('media/avatars/avatar4.jpg')}}" alt="">
                        </td>
                        <td>
                ...
                <div class="block-content">
                  <table class="table table-striped table-hover table-borderless table-vcenter fs-sm">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <span class="fw-semibold">Isuzu Elf</span>
                        </td>
                      ...
                      <tr>
                        <td>
                          <span class="fw-semibold">MacBook Pro 13"</span>
                        </td>
                        <td class="d-none d-sm-table-cell">
                          <span class="fs-sm text-muted">today</span>
                        </td>
                      ...
                      <tr>
                        <td>
                          <span class="fw-semibold">75" Smart Television</span>
                        </td>
                        <td class="d-none d-sm-table-cell">
                          <span class="fs-sm text-muted">today</span>
                        </td>
                      ...
                      <tr>
                        <td>
                          <span class="fw-semibold">50" Smart Board for Students</span>
                        </td>
                        <td class="d-none d-sm-table-cell">
                      ...
                      <tr>
                        <td>
                          <span class="fw-semibold">Acer Aspire 5</span>
                        </td>
                        <td class="d-none d-sm-table-cell">
                          <span class="fs-sm text-muted">yesterday</span>
                        </td>
                      ...
                      <tr>
                        <td>
                          <span class="fw-semibold">Tablets for Students</span>
                        </td>
                        <td class="d-none d-sm-table-cell">
                          <span class="fs-sm text-muted">yesterday</span>
                        </td>
                      ...
                      <tr>
                        <td>
                          <span class="fw-semibold">Foton Tornado</span>
                        </td>
                        <td class="d-none d-sm-table-cell">
                          <span class="fs-sm text-muted">yesterday</span>
                        </td>
